...
public class VuePrincipale {
	...
	private HashMap<Integer,ArrayList<Message>> conv=new HashMap<>();//id, liste de message
	private HashMap<Integer,Boolean> unread=new HashMap<>();//id, lu ou pas
	private JList<Interlocuteurs> list = new JList<>();
	private Interlocuteurs activeUser;
...
// create menu item and add it to the menu
	...
	protected void loadConversation(int i) {
		ArrayList<Message> c=conv.get(i);
		if(c != null) {
			setHtmlView(c);
		}else {
	 ...
	 */
	public void update(Interlocuteurs emetteur, Message message, boolean sent) {
